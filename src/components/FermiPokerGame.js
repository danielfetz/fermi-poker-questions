      ...
      <div className="flex flex-wrap justify-between items-center border-b pb-3 mb-4 relative z-10">
        ...
        <div>
          <button
            ...
            className="rules-button flex items-center justify-center w-9 h-9 rounded-lg border border-rich-brown bg-rich-brown text-warm-cream hover:bg-dark-brown transition-all shadow-md"
            aria-label="Show game rules"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.25 9.25v-4.5m0 4.5h4.5m-4.5 0l6-6m-3 18c6.213 0 9.75-7.295 5.5-11.75-1.366-1.431-3.296-2.25-5.5-2.25-3.866 0-7 3.134-7 7 0 3.866 3.134 7 7 7z" />
            </svg>
          </button>
        </div>
      </div>
